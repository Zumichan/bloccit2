...
const base = "http://localhost:3000/topics";//no / necessary since it's included in the test spec
...
describe("routes : posts", () => {
  ...
  // context of guest (not signed in) user
  describe("guest user performing CRUD actions for Post", () => {
    ...
    beforeEach((done) => {
      request.get({
          ...
          form: {
            userId:0 //userId starts from 1 for signed up users
          }
        },
        (err,res,body)=>{
          done();
