...
describe("Comment", () => {
  ...
  describe("#create()", () => {
    ...
    //We test that comments with invalid attributes are not created
  ...
  //We test `setPost` which should associate the Post passed as argument to the comment called on
  describe("#setPost()", () => {
